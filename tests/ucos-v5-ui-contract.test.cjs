...
assert(sw.includes("const CACHE='super-api-ucos-v24'"),'v6 current cache generation missing');
assert(sw.includes("const PREVIOUS='super-api-ucos-v23'"),'v5 recovery cache was not retained');
...
console.log('UCOS v5 session and staged-update compatibility passed');
