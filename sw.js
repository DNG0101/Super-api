const CACHE='super-api-peer-lab-v9';
const CORE=['./','./index.html','./app.js','./catalog.js','./peer-hook.js','./session-consent.js','./api-extensions.js','./deep-api-tests.js','./session-bootstrap.js','./runtime-surface.js','./emerging-apis.js','./manifest.webmanifest','./icon.svg'];
