const CACHE='super-api-peer-lab-v8';
const CORE=['./','./index.html','./app.js','./catalog.js','./peer-hook.js','./session-consent.js','./api-extensions.js','./deep-api-tests.js','./session-bootstrap.js','./runtime-surface.js','./manifest.webmanifest','./icon.svg'];
