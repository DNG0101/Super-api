const CACHE='super-api-peer-lab-v19';
const CORE=['./','./index.html','./app.js','./catalog.js','./peer-hook.js','./session-consent.js','./api-extensions.js','./deep-api-tests.js','./session-bootstrap.js','./runtime-surface.js','./emerging-apis.js','./realm-scanners.js','./mdn-live-index.js','./interface-harness.js','./latest-platform.js','./modules/realm-rpc.js','./modules/universal-core.js','./modules/universal-api.js','./modules/universal-api-v2.js','./modules/network-signal-core.js','./modules/network-signal.js','./modules/wireless-radio-core.js','./modules/wireless-radio.js','./modules/capability-os-core.js','./modules/capability-os.js','./workers/realm-rpc-sw.js','./manifest.webmanifest','./icon.svg'];
